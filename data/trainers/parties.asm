...
BrunoGroup:
	...
	db 42, HITMONTOP,  POISON_TAIL, QUICK_ATTACK, DIG, DETECT ; REPLACE
...
KarenGroup:
	...
	db 44, MURKROW,    QUICK_ATTACK, WHIRLWIND, POISON_TAIL, FAINT_ATTACK ; REPLACE
	db 47, HOUNDOOM,   ROAR, POISON_TAIL, FLAMETHROWER, CRUNCH ; REPLACE
	db -1 ; end
...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, POISON_TAIL ; REPLACE
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, POISON_TAIL ; REPLACE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 32, BEEDRILL,   FURY_ATTACK, POISON_TAIL, TWINEEDLE, DOUBLE_TEAM ; REPLACE
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    PECK, POISON_TAIL, HAZE, NIGHT_SHADE ; REPLACE
	db -1 ; end
	...
	db 25, MURKROW,    PECK, POISON_TAIL, HAZE, NO_MOVE ; REPLACE
	db -1 ; end
