...
WhitneyGroup:
	...
	db 18, CLEFAIRY,   SIGNAL_BEAM, MIMIC, ENCORE, METRONOME
	db 20, MILTANK,    ROLLOUT, ATTRACT, STOMP, DARK_PULSE
	db -1 ; end
...
MortyGroup:
	...
	db 21, HAUNTER,    HYPNOSIS, MIMIC, CURSE, ENERGY_BALL ; REPLACE ENERGY BALL
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, HAUNTER,    SPITE, MEAN_LOOK, MIMIC, ENERGY_BALL ; REPLACE ENERGY BALL
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, MUD_SHOT, THUNDER_WAVE ; REPLACE MUD SHOT
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, MUD_SHOT, THUNDER_WAVE ; REPLACE MUD SHOT
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, POWER_GEM, KARATE_CHOP, FURY_ATTACK ; REPLACE POWER_GEM
	db 30, POLIWRATH,  HYPNOSIS, WILD_CHARGE, SURF, ICICLE_CRASH ; REPLACE ICICLE CRASH
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, SHADOW_SNEAK, DRAGONBREATH ; REPLACE SHADOW SNEAK
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SHADOW_SNEAK, DRAGONBREATH ; REPLACE SHADOW SNEAK
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SHADOW_SNEAK, DRAGONBREATH ; REPLACE SHADOW SNEAK
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, MUD_SHOT ; REPLACE MUD SHOT
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, MUD_SHOT ; REPLACE MUD SHOT
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, CROCONAW,   LEER, POWER_GEM, WATER_GUN, BITE ; REPLACE POWER_GEM
	db -1 ; end

	; RIVAL1 (10)
	db "?@", TRAINERTYPE_MOVES
	db 30, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, MUD_SHOT, THUNDER_WAVE ; REPLACE MUD SHOT
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, POWER_GEM, WATER_GUN, BITE, SCARY_FACE ; REPLACE POWER_GEM
	db -1 ; end
	...
	db 35, MAGNETON,   THUNDERSHOCK, MUD_SHOT, THUNDER_WAVE, SWIFT ; REPLACE MUD SHOT
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, MUD_SHOT, THUNDER_WAVE, SWIFT ; REPLACE MUD SHOT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, POWER_GEM, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 41, JYNX,       SIGNAL_BEAM, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, SHADOW_CLAW, PSYCHIC_M ; REPLACE SHADOW CLAW
...
BrunoGroup:
	...
	db 42, HITMONTOP,  POISON_TAIL, QUICK_ATTACK, DIG, FLARE_BLITZ ; REPLACE POISON TAIL
...
KarenGroup:
	...
	db 44, MURKROW,    QUICK_ATTACK, WHIRLWIND, POISON_TAIL, FAINT_ATTACK ; REPLACE POISON TAIL
	db 47, HOUNDOOM,   ROAR, POISON_TAIL, FLAMETHROWER, CRUNCH ; REPLACE POISON TAIL
	db -1 ; end
...
BrockGroup:
	...
	db 42, OMASTAR,    BITE, SURF, PROTECT, FURY_ATTACK
...
LtSurgeGroup:
	...
	db 40, MAGNETON,   LOCK_ON, DOUBLE_TEAM, SWIFT, LEAF_BLADE
	db 40, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   LEER, QUICK_ATTACK, HYPER_FANG, POISON_TAIL ; REPLACE POISON TAIL
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, POISON_TAIL ; REPLACE POISON TAIL
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, ELECTRODE,  SCREECH, MUD_SHOT, ROLLOUT, LIGHT_SCREEN ; REPLACE MUD SHOT
	db 35, GROWLITHE,  SUNNY_DAY, PLAY_ROUGH, TAKE_DOWN, FLAME_WHEEL
	...
	db 35, XATU,       PECK, ENERGY_BALL, SWIFT, FUTURE_SIGHT ; REPLACE ENERGY BALL
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, MUD_SHOT, SUPERSONIC ; REPLACE MUD SHOT
	db 35, QUAGSIRE,   LEER, SHADOW_SNEAK, AMNESIA, EARTHQUAKE ; REPLACE SHADOW SNEAK
	db -1 ; end
	...
	db 38, MAGNETON,   LEAF_BLADE, THUNDER_WAVE, LOCK_ON, SWIFT
	db -1 ; end
...
BirdKeeperGroup:
	...
	db 40, FARFETCH_D, FURY_ATTACK, FLARE_BLITZ, FLY, SLASH
	db -1 ; end
	...
	db 38, PIDGEOT,    SWIFT, FLARE_BLITZ, STEEL_WING, FLY
	db -1 ; end
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, ENERGY_BALL ; REPLACE ENERGY BALL
...
CooltrainerMGroup:
	...
	db 26, CHARMANDER, EMBER, SMOKESCREEN, POWER_GEM, SCARY_FACE ; REPLACE POWER_GEM
	...
	db 35, KINGLER,    BUBBLEBEAM, STOMP, HORN_DRILL, PROTECT
	...
	db 39, KINGLER,    KINGS_ROCK,   SURF, STOMP, HORN_DRILL, BLIZZARD
	...
	db 32, KINGLER,    BUBBLEBEAM, STOMP, HORN_DRILL, PROTECT
	...
	db 31, QUAGSIRE,   WATER_GUN, SHADOW_SNEAK, AMNESIA, EARTHQUAKE ; REPLACE SHADOW SNEAK
	...
	db 27, CHARMELEON, EMBER, SMOKESCREEN, POWER_GEM, SCARY_FACE ; REPLACE POWER_GEM
	db -1 ; end

	; COOLTRAINERM (20)
	db "DARIN@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_PULSE, SHADOW_SNEAK ; REPLACE SHADOW SNEAK
	db -1 ; end
...
BeautyGroup:
	...
	db 17, HOPPIP,     SYNTHESIS, FAIRY_WIND, TACKLE, POISONPOWDER
	db 17, SKIPLOOM,   SYNTHESIS, FAIRY_WIND, TACKLE, STUN_SPORE
	db -1 ; end
...
PokemaniacGroup:
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, CHANSEY, ROLLOUT, ATTRACT, SHADOW_CLAW, RECOVER ; REPLACE SHADOW CLAW
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, POWER_GEM ; REPLACE POWER_GEM
	...
	db 32, BEEDRILL,   FURY_ATTACK, POISON_TAIL, TWINEEDLE, DOUBLE_TEAM ; REPLACE POISON TAIL
...
SwimmerFGroup:
	...
	db 21, HORSEA,     AIR_CUTTER, SMOKESCREEN, LEER, WATER_GUN  ; REPLACE AIR CUTTER
...
SailorGroup:
	...
	db 18, KRABBY,     AIR_CUTTER, LEER, HYPER_VOICE, HARDEN ; REPLACE HYPER VOICE, AIR CUTTER
	db 20, KRABBY,     BUBBLEBEAM, LEER, HYPER_VOICE, HARDEN ; REPLACE HYPER VOICE
	db -1 ; end
...
Rival2Group:
	...
	db 41, MAGNETON,   THUNDERSHOCK, MUD_SHOT, THUNDER_WAVE, SWIFT ; REPLACE MUD SHOT
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, FERALIGATR, POWER_GEM, WATER_GUN, SCARY_FACE, SLASH ; REPLACE POWER_GEM
	db -1 ; end
	...
	db 45, MAGNETON,   THUNDER, MUD_SHOT, THUNDER_WAVE, SWIFT ; REPLACE MUD SHOT
...
HikerGroup:
	...
	db 38, STEELIX,    DIG, IRON_TAIL, SANDSTORM, SHADOW_SNEAK ; REPLACE SHADOW SNEAK
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, MEDITATE, AURA_SPHERE, FOCUS_ENERGY ; REPLACE AURA SPHERE
	db -1 ; end
	...
	db 27, HITMONCHAN, FURY_ATTACK, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
PsychicGroup:
	...
	db 24, NATU,       LEER, ENERGY_BALL, FUTURE_SIGHT, CONFUSE_RAY ; REPLACE ENERGY BALL
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, SIGNAL_BEAM, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, CLEFAIRY,   ENCORE, SIGNAL_BEAM, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, SIGNAL_BEAM, MINIMIZE
	db -1 ; end
	...
	db 33, JUMPLUFF,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, FAIRY_WIND
	db 33, JUMPLUFF,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, FAIRY_WIND
	db 38, VENUSAUR,   SOLARBEAM, RAZOR_LEAF, HEADBUTT, MUD_SLAP
	db -1 ; end

	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, CLEFAIRY,   METRONOME, MOONBLAST, MOONLIGHT, MINIMIZE
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    PECK, POISON_TAIL, HAZE, ENERGY_BALL ; REPLACE ENERGY BALL, POSION TAIL
	db -1 ; end
	...
	db 25, MURKROW,    PECK, POISON_TAIL, HAZE, NO_MOVE ; REPLACE POSION TAIL
	db -1 ; end
...
TwinsGroup:
	...
	db 16, CLEFAIRY,   GROWL, ENCORE, SIGNAL_BEAM, METRONOME
...
BlueGroup:
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, SHADOW_CLAW, SOLARBEAM ; REPLACE SHADOW CLAW
...
MysticalmanGroup:
	...
	db 25, ELECTRODE,  SCREECH, MUD_SHOT, THUNDER, ROLLOUT ; REPLACE MUD SHOT
	db -1 ; end
