...
MortyGroup:
	...
	db 23, HAUNTER,    SPITE, MEAN_LOOK, MIMIC, SHADOW_SNEAK
	db -1 ; end
...
JasmineGroup:
	...
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, MIRROR_SHOT, THUNDER_WAVE
	db 30, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, MIRROR_SHOT, THUNDER_WAVE
...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, SUBMISSION, KARATE_CHOP, FURY_ATTACK
	db 30, POLIWRATH,  HYPNOSIS, MUD_SHOT, SURF, SUBMISSION
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, BREAKING_SWIPE, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, BREAKING_SWIPE, DRAGONBREATH
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, BREAKING_SWIPE, DRAGONBREATH
...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, MIRROR_SHOT
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, MIRROR_SHOT, THUNDER_WAVE
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, FERALIGATR, SLASH, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 35, MAGNETON,   THUNDERSHOCK, MIRROR_SHOT, THUNDER_WAVE, SWIFT
	...
	db 34, SNEASEL,    QUICK_ATTACK, SCREECH, FAINT_ATTACK, FURY_CUTTER
	db 36, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 34, MAGNETON,   THUNDERSHOCK, MIRROR_SHOT, THUNDER_WAVE, SWIFT
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
...
WillGroup:
	...
	db 41, EXEGGUTOR,  REFLECT, LEECH_SEED, ENERGY_BALL, PSYCHIC_M
...
BrunoGroup:
	...
	db 42, HITMONTOP,  DOUBLE_KICK, QUICK_ATTACK, DIG, COUNTER
...
KarenGroup:
	...
	db 44, MURKROW,    QUICK_ATTACK, WHIRLWIND, AIR_CUTTER, FAINT_ATTACK
...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   LEER, QUICK_ATTACK, HYPER_FANG, HEADBUTT
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 37, RATICATE,   HYPER_BEAM, QUICK_ATTACK, HYPER_FANG, HEADBUTT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, XATU,       PECK, AIR_CUTTER, SWIFT, FUTURE_SIGHT
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, AIR_CUTTER, SUPERSONIC
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, ACID
...
CooltrainerMGroup:
	...
	db 37, DRAGONAIR,  WRAP, SURF, DRAGON_PULSE, BREAKING_SWIPE
	db -1 ; end
...
BugCatcherGroup:
	...
	db 25, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, SLUDGE_BOMB
	...
	db 32, BEEDRILL,   FURY_ATTACK, SLUDGE_BOMB, TWINEEDLE, DOUBLE_TEAM
...
SailorGroup:
	...
	db 18, KRABBY,     BUBBLEBEAM, LEER, SCRATCH, HARDEN
	db 20, KRABBY,     BUBBLEBEAM, LEER, SCRATCH, HARDEN
	db -1 ; end
...
Rival2Group:
	...
	db 41, MAGNETON,   THUNDERSHOCK, MIRROR_SHOT, THUNDER_WAVE, SWIFT
	...
	db 45, MAGNETON,   THUNDER, MIRROR_SHOT, THUNDER_WAVE, SWIFT
...
HikerGroup:
	...
	db 38, STEELIX,    DIG, IRON_TAIL, SANDSTORM, BULLDOZE
	db -1 ; end
...
PsychicGroup:
	...
	db 24, NATU,       LEER, CONFUSION, FUTURE_SIGHT, CONFUSE_RAY
...
ExecutiveFGroup:
	...
	db 32, MURKROW,    PECK, AIR_CUTTER, HAZE, FAINT_ATTACK
	db -1 ; end
	...
	db 25, MURKROW,    PECK, AIR_CUTTER, HAZE, NO_MOVE
	db -1 ; end
...
BlueGroup:
	...
	db 58, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, ENERGY_BALL, SOLARBEAM
