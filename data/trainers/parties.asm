...
ChuckGroup:
	...
	db 27, PRIMEAPE,   LEER, POWER_GEM, KARATE_CHOP, FURY_SWIPES ; REPLACE POWER_GEM
...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, POISON_TAIL ; REPLACE POISON TAIL
	db -1 ; end
...
SchoolboyGroup:
	...
	db 35, QUAGSIRE,   TAIL_WHIP, SHADOW_SNEAK, AMNESIA, EARTHQUAKE ; REPLACE SHADOW SNEAK
	db -1 ; end
