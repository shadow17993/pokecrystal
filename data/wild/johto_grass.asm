...
JohtoGrassWildMons:
	...
	; morn
	db 30, LEDYBA,	  	  13,  13
	db 30, GROWLITHE,	  14,  14
	db 20, PIDGEY,	  	  15,  15
	db 10, GROWLITHE,	  16,  16
	...
	db 30, STANTLER,	  14,  14
	db 20, HOOTHOOT,	  15,  15
	db 10, STANTLER,	  16,  16
	db  5, NOCTOWL,	  	  15,  15
	db  4, ARIADOS,	  	  15,  15
	db  1, ARIADOS,	  	  15,  15
	end_grass_wildmons
	...
	; morn
	db 30, TANGELA,	  	  23,  23
	db 30, LICKITUNG,	  22,  22
	db 20, BELLSPROUT,	  22,  22
	db 10, WEEPINBELL,	  24,  24
	db  5, LICKITUNG,	  24,  24
	db  4, LICKITUNG,	  26,  26
	db  1, LICKITUNG,	  26,  26
	; day
	db 30, TANGELA,	  	  23,  23
	db 30, LICKITUNG,	  22,  22
	db 20, BELLSPROUT,	  22,  22
	...
	db 20, BELLSPROUT,	  22,  22
	db 10, WEEPINBELL,	  24,  24
	db  5, POLIWHIRL,	  24,  24
	db  4, POLIWHIRL,	  26,  26
	db  1, POLIWHIRL,	  26,  26
	end_grass_wildmons
