...
KantoGrassWildMons:
	...
	db  1, DODRIO,	  	  30, 30
	; nite
	db 30, QUAGSIRE,	  28, 28
	db 30, NOCTOWL,	  	  28, 28
	db 20, RATICATE,	  30, 30
	db 10, QUAGSIRE,	  30, 30
	db  5, NOCTOWL,	  	  32, 32
	db  4, NOCTOWL,	  	  32, 32
	db  1, NOCTOWL,	  	  32, 32
	end_grass_wildmons
