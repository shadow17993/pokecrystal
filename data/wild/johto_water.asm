...
JohtoWaterWildMons:
	...
	db 60, WOOPER,	  	  15, 15
	db 30, QUAGSIRE,	  20, 20
	db 10, QUAGSIRE,	  15, 15
	end_water_wildmons
	...
	db 60, TENTACOOL,	  15, 15
	db 30, QUAGSIRE,	  20, 20
	db 10, TENTACRUEL,	  20, 20
	end_water_wildmons

	def_water_wildmons SLOWPOKE_WELL_B1F
	db 2 percent ; encounter rate
	db 60, SLOWPOKE,	  15, 15
	db 30, SLOWPOKE,	  20, 20
	...
	db 2 percent ; encounter rate
	db 60, MAGIKARP,	  15, 15
	db 30, MAGIKARP,	  10, 10
	db 10, MAGIKARP,	  5,  5
	end_water_wildmons
	...
	db 2 percent ; encounter rate
	db 60, MAGIKARP,	  20, 20
	db 30, MAGIKARP,	  15, 15
	db 10, MAGIKARP,	  10, 10
	end_water_wildmons
