...
; BattleTowerMons group 1
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, DRAGON_CLAW, ICY_WIND
	dw 0 ; OT ID
	dt 1000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 2
	...
	db AERODACTYL
	db GOLD_BERRY
	db REST, HYPER_BEAM, EARTHQUAKE, DRAGON_PULSE
	dw 0 ; OT ID
	dt 8000 ; Exp
	...
	db HITMONCHAN
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, GIGA_IMPACT
	dw 0 ; OT ID
	dt 8000 ; Exp
...
; BattleTowerMons group 3
	...
	db GENGAR
	db GOLD_BERRY
	db THIEF, LICK, ENERGY_BALL, GIGA_DRAIN ; REPLACE ENERGY BALL
	dw 0 ; OT ID
	dt 27000 ; Exp
	...
	db FEAROW
	db BRIGHTPOWDER
	db MIRROR_MOVE, POISON_TAIL, PECK, SWIFT ; REPLACE
	dw 0 ; OT ID
	dt 27000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db ECHOED_VOICE, KARATE_CHOP, REVERSAL, FOCUS_ENERGY ; REPLACE
	dw 0 ; OT ID
	dt 27000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 4
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, GIGA_IMPACT, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 213, 224, 200, 224, 213, 213 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db SCIZOR
	db SCOPE_LENS
	db SLASH, STEEL_WING, POISON_TAIL, HYPER_BEAM ; REPLACE
	dw 0 ; OT ID
	dt 64000 ; Exp
	...
	db CHARIZARD
	db KINGS_ROCK
	db FIRE_SPIN, DRAGON_PULSE, FLY, SLASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db SHADOW_CLAW, STOMP, PSYCH_UP, CONFUSION ; REPLACE
	dw 0 ; OT ID
	dt 64000 ; Exp
	db 224, 224, 224, 224, 224, 224 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 5
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, SURF, RAIN_DANCE, LEAF_BLADE
	dw 0 ; OT ID
	dt 125000 ; Exp
	db 200, 200, 200, 200, 200, 200 ; EVs
	db 0, 0, 0, 0 ; padding
...
; BattleTowerMons group 10
	...
	db LANTURN
	db QUICK_CLAW
	db SURF, RAIN_DANCE, LEAF_BLADE, CONFUSE_RAY
	dw 0 ; OT ID
	dt 1000000 ; Exp
	db 174, 174, 174, 174, 174, 174 ; EVs
	db 0, 0, 0, 0 ; padding
